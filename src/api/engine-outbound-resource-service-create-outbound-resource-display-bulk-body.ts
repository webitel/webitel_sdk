 ...
 *
 * @export
 * @interface EngineOutboundResourceServiceCreateOutboundResourceDisplayBulkBody
 */
export interface EngineOutboundResourceServiceCreateOutboundResourceDisplayBulkBody {
   ...
   * @memberof EngineOutboundResourceServiceCreateOutboundResourceDisplayBulkBody
   */
