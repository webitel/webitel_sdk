...
export const AgentServiceApiAxiosParamCreator = function(
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    agentServiceAgentTodayStatistics: async (
      agentId: string,
      fields?: Array<string>,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (agentId === null || agentId === undefined) {
        throw new RequiredError(
          'agentId',
          'Required parameter agentId was null or undefined when calling agentServiceAgentTodayStatistics.'
        )
      }
...
export const AgentServiceApiFp = function(configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async agentServiceAgentTodayStatistics(
      agentId: string,
      fields?: Array<string>,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await AgentServiceApiAxiosParamCreator(
        configuration
      ).agentServiceAgentTodayStatistics(agentId, fields, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
export const AgentServiceApiFactory = function(
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    agentServiceAgentTodayStatistics(
      agentId: string,
      fields?: Array<string>,
      options?: any
    ): AxiosPromise<EngineAgentTodayStatisticsResponse> {
...
export class AgentServiceApi extends BaseAPI {
   ...
   * @memberof AgentServiceApi
   */
  public agentServiceAgentTodayStatistics(
    agentId: string,
    fields?: Array<string>,
    options?: any
  ) {
