  ...
  function Ne(t, e, n, r) {
    ...
    for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
      let l = r.data.rows[Number(s[o].ref)],
        u = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${
          l.kind
        }"></use></svg>`,
        d = he(l.name, i)
  ...
  var Y = class extends I {
    constructor(e) {
      super(e),
        ...
        (ge.innerHTML += `html:not(.${this.key}) .tsd-is-${
          this.el.name
        } { display: none; }
`),
  ...
  var Z = class extends I {
    constructor(e) {
      super(e),
        ...
        (this.key = `tsd-accordion-${this.summary.dataset.key ??
  ...
  function be(t, e, n) {
    if (t.path) {
      ...
      ;(r.href = K + t.path),
        ...
        t.kind &&
          (r.innerHTML = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="tsd-kind-icon"><use href="#icon-${
            t.kind
          }"></use></svg>`),
